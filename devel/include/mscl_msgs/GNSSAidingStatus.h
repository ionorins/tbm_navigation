// Generated by gencpp from file mscl_msgs/GNSSAidingStatus.msg
// DO NOT EDIT!


#ifndef MSCL_MSGS_MESSAGE_GNSSAIDINGSTATUS_H
#define MSCL_MSGS_MESSAGE_GNSSAIDINGSTATUS_H
...
struct GNSSAidingStatus_
{
  ...
  typedef boost::shared_ptr< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> const> ConstPtr;

}; // struct GNSSAidingStatus_

typedef ::mscl_msgs::GNSSAidingStatus_<std::allocator<void> > GNSSAidingStatus;

typedef boost::shared_ptr< ::mscl_msgs::GNSSAidingStatus > GNSSAidingStatusPtr;
typedef boost::shared_ptr< ::mscl_msgs::GNSSAidingStatus const> GNSSAidingStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator1> & lhs, const ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x93a07537312a9e61ULL;
  static const uint64_t static_value2 = 0x6123b06cec1efdf6ULL;
};

template<class ContainerAllocator>
struct DataType< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mscl_msgs::GNSSAidingStatus_<ContainerAllocator>& v)
  {
    s << indent << "gps_tow: ";
...
#endif // MSCL_MSGS_MESSAGE_GNSSAIDINGSTATUS_H
