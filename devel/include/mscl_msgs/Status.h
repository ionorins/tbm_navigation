// Generated by gencpp from file mscl_msgs/Status.msg
// DO NOT EDIT!


#ifndef MSCL_MSGS_MESSAGE_STATUS_H
#define MSCL_MSGS_MESSAGE_STATUS_H
...
struct Status_
{
  ...
  typedef boost::shared_ptr< ::mscl_msgs::Status_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mscl_msgs::Status_<ContainerAllocator> const> ConstPtr;

}; // struct Status_

typedef ::mscl_msgs::Status_<std::allocator<void> > Status;

typedef boost::shared_ptr< ::mscl_msgs::Status > StatusPtr;
typedef boost::shared_ptr< ::mscl_msgs::Status const> StatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::mscl_msgs::Status_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::mscl_msgs::Status_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::mscl_msgs::Status_<ContainerAllocator1> & lhs, const ::mscl_msgs::Status_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::mscl_msgs::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mscl_msgs::Status_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mscl_msgs::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mscl_msgs::Status_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mscl_msgs::Status_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mscl_msgs::Status_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::mscl_msgs::Status_<ContainerAllocator> >
{
  ...
  static const char* value(const ::mscl_msgs::Status_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb19b8bec6f96c609ULL;
  static const uint64_t static_value2 = 0x664c27dbc51ddf60ULL;
};

template<class ContainerAllocator>
struct DataType< ::mscl_msgs::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::mscl_msgs::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mscl_msgs::Status_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::mscl_msgs::Status_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mscl_msgs::Status_<ContainerAllocator>& v)
  {
...
#endif // MSCL_MSGS_MESSAGE_STATUS_H
