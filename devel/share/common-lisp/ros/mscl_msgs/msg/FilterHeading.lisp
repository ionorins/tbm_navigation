...
(cl:defmethod cl:initialize-instance :after ((m <FilterHeading>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FilterHeading)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mscl_msgs-msg:<FilterHeading> is deprecated: use mscl_msgs-msg:FilterHeading instead.")))

(cl:ensure-generic-function 'heading_deg-val :lambda-list '(m))
(cl:defmethod heading_deg-val ((m <FilterHeading>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:heading_deg-val is deprecated.  Use mscl_msgs-msg:heading_deg instead.")
  (heading_deg m))
