...
(cl:defmethod cl:initialize-instance :after ((m <FilterHeadingState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FilterHeadingState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mscl_msgs-msg:<FilterHeadingState> is deprecated: use mscl_msgs-msg:FilterHeadingState instead.")))

(cl:ensure-generic-function 'heading_rad-val :lambda-list '(m))
(cl:defmethod heading_rad-val ((m <FilterHeadingState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:heading_rad-val is deprecated.  Use mscl_msgs-msg:heading_rad instead.")
  (heading_rad m))
...
(cl:defmethod heading_uncertainty-val ((m <FilterHeadingState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:heading_uncertainty-val is deprecated.  Use mscl_msgs-msg:heading_uncertainty instead.")
  (heading_uncertainty m))

(cl:ensure-generic-function 'source-val :lambda-list '(m))
(cl:defmethod source-val ((m <FilterHeadingState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:source-val is deprecated.  Use mscl_msgs-msg:source instead.")
  (source m))
