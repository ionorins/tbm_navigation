...
(cl:defmethod cl:initialize-instance :after ((m <FilterStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FilterStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mscl_msgs-msg:<FilterStatus> is deprecated: use mscl_msgs-msg:FilterStatus instead.")))

(cl:ensure-generic-function 'filter_state-val :lambda-list '(m))
(cl:defmethod filter_state-val ((m <FilterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:filter_state-val is deprecated.  Use mscl_msgs-msg:filter_state instead.")
  (filter_state m))

(cl:ensure-generic-function 'dynamics_mode-val :lambda-list '(m))
(cl:defmethod dynamics_mode-val ((m <FilterStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:dynamics_mode-val is deprecated.  Use mscl_msgs-msg:dynamics_mode instead.")
  (dynamics_mode m))
