...
(cl:defmethod cl:initialize-instance :after ((m <GNSSAidingStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GNSSAidingStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mscl_msgs-msg:<GNSSAidingStatus> is deprecated: use mscl_msgs-msg:GNSSAidingStatus instead.")))
...
(cl:defmethod has_position_fix-val ((m <GNSSAidingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:has_position_fix-val is deprecated.  Use mscl_msgs-msg:has_position_fix instead.")
  (has_position_fix m))

(cl:ensure-generic-function 'tight_coupling-val :lambda-list '(m))
(cl:defmethod tight_coupling-val ((m <GNSSAidingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:tight_coupling-val is deprecated.  Use mscl_msgs-msg:tight_coupling instead.")
  (tight_coupling m))
...
(cl:defmethod differential_corrections-val ((m <GNSSAidingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:differential_corrections-val is deprecated.  Use mscl_msgs-msg:differential_corrections instead.")
...
(cl:defmethod integer_fix-val ((m <GNSSAidingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:integer_fix-val is deprecated.  Use mscl_msgs-msg:integer_fix instead.")
  (integer_fix m))

(cl:ensure-generic-function 'using_gps-val :lambda-list '(m))
(cl:defmethod using_gps-val ((m <GNSSAidingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:using_gps-val is deprecated.  Use mscl_msgs-msg:using_gps instead.")
  (using_gps m))

(cl:ensure-generic-function 'using_glonass-val :lambda-list '(m))
(cl:defmethod using_glonass-val ((m <GNSSAidingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:using_glonass-val is deprecated.  Use mscl_msgs-msg:using_glonass instead.")
  (using_glonass m))

(cl:ensure-generic-function 'using_galileo-val :lambda-list '(m))
(cl:defmethod using_galileo-val ((m <GNSSAidingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:using_galileo-val is deprecated.  Use mscl_msgs-msg:using_galileo instead.")
  (using_galileo m))

(cl:ensure-generic-function 'using_beidou-val :lambda-list '(m))
(cl:defmethod using_beidou-val ((m <GNSSAidingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:using_beidou-val is deprecated.  Use mscl_msgs-msg:using_beidou instead.")
  (using_beidou m))
