...
(cl:defclass <GPSCorrelationTimestampStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (gps_cor
    :reader gps_cor
    :initarg :gps_cor
    :type mscl_msgs-msg:GPSCorrelationTimestamp
    :initform (cl:make-instance 'mscl_msgs-msg:GPSCorrelationTimestamp)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GPSCorrelationTimestampStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPSCorrelationTimestampStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mscl_msgs-msg:<GPSCorrelationTimestampStamped> is deprecated: use mscl_msgs-msg:GPSCorrelationTimestampStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <GPSCorrelationTimestampStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:header-val is deprecated.  Use mscl_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'gps_cor-val :lambda-list '(m))
(cl:defmethod gps_cor-val ((m <GPSCorrelationTimestampStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:gps_cor-val is deprecated.  Use mscl_msgs-msg:gps_cor instead.")
  (gps_cor m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GPSCorrelationTimestampStamped>)))
  ...
  "mscl_msgs/GPSCorrelationTimestampStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GPSCorrelationTimestampStamped)))
  "Returns string type for a message object of type 'GPSCorrelationTimestampStamped"
  "mscl_msgs/GPSCorrelationTimestampStamped")
