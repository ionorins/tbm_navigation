...
(cl:defmethod cl:initialize-instance :after ((m <ExternalHeadingUpdate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExternalHeadingUpdate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<ExternalHeadingUpdate-request> is deprecated: use ros_mscl-srv:ExternalHeadingUpdate-request instead.")))

(cl:ensure-generic-function 'gps_tow-val :lambda-list '(m))
(cl:defmethod gps_tow-val ((m <ExternalHeadingUpdate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:gps_tow-val is deprecated.  Use ros_mscl-srv:gps_tow instead.")
  (gps_tow m))
...
(cl:defmethod gps_week_number-val ((m <ExternalHeadingUpdate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:gps_week_number-val is deprecated.  Use ros_mscl-srv:gps_week_number instead.")
  (gps_week_number m))

(cl:ensure-generic-function 'heading_rad-val :lambda-list '(m))
(cl:defmethod heading_rad-val ((m <ExternalHeadingUpdate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:heading_rad-val is deprecated.  Use ros_mscl-srv:heading_rad instead.")
  (heading_rad m))
...
(cl:defmethod heading_1sigma_rad-val ((m <ExternalHeadingUpdate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:heading_1sigma_rad-val is deprecated.  Use ros_mscl-srv:heading_1sigma_rad instead.")
...
(cl:defmethod heading_type-val ((m <ExternalHeadingUpdate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:heading_type-val is deprecated.  Use ros_mscl-srv:heading_type instead.")
  (heading_type m))

(cl:ensure-generic-function 'use_time-val :lambda-list '(m))
(cl:defmethod use_time-val ((m <ExternalHeadingUpdate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:use_time-val is deprecated.  Use ros_mscl-srv:use_time instead.")
  (use_time m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExternalHeadingUpdate-request>)))
  ...
  "ros_mscl/ExternalHeadingUpdateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExternalHeadingUpdate-request)))
  "Returns string type for a service object of type 'ExternalHeadingUpdate-request"
  "ros_mscl/ExternalHeadingUpdateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ExternalHeadingUpdate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExternalHeadingUpdate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<ExternalHeadingUpdate-response> is deprecated: use ros_mscl-srv:ExternalHeadingUpdate-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExternalHeadingUpdate-response>)))
  ...
  "ros_mscl/ExternalHeadingUpdateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExternalHeadingUpdate-response)))
  "Returns string type for a service object of type 'ExternalHeadingUpdate-response"
  "ros_mscl/ExternalHeadingUpdateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExternalHeadingUpdate)))
  ...
  "ros_mscl/ExternalHeadingUpdate")