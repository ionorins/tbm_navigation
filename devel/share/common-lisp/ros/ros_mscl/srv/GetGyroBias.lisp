...
(cl:defmethod cl:initialize-instance :after ((m <GetGyroBias-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetGyroBias-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<GetGyroBias-request> is deprecated: use ros_mscl-srv:GetGyroBias-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetGyroBias-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetGyroBias-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<GetGyroBias-response> is deprecated: use ros_mscl-srv:GetGyroBias-response instead.")))
