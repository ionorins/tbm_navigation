...
(cl:defmethod cl:initialize-instance :after ((m <GetGyroNoise-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetGyroNoise-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<GetGyroNoise-request> is deprecated: use ros_mscl-srv:GetGyroNoise-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetGyroNoise-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetGyroNoise-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<GetGyroNoise-response> is deprecated: use ros_mscl-srv:GetGyroNoise-response instead.")))
