...
(cl:defmethod cl:initialize-instance :after ((m <GetMagNoise-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetMagNoise-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<GetMagNoise-request> is deprecated: use ros_mscl-srv:GetMagNoise-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetMagNoise-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetMagNoise-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<GetMagNoise-response> is deprecated: use ros_mscl-srv:GetMagNoise-response instead.")))
