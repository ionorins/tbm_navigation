...
(cl:defmethod cl:initialize-instance :after ((m <SetAccelBias-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAccelBias-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetAccelBias-request> is deprecated: use ros_mscl-srv:SetAccelBias-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetAccelBias-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAccelBias-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetAccelBias-response> is deprecated: use ros_mscl-srv:SetAccelBias-response instead.")))
