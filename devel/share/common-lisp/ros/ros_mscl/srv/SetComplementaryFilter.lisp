...
(cl:defmethod cl:initialize-instance :after ((m <SetComplementaryFilter-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetComplementaryFilter-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetComplementaryFilter-request> is deprecated: use ros_mscl-srv:SetComplementaryFilter-request instead.")))
...
(cl:defmethod north_comp_enable-val ((m <SetComplementaryFilter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:north_comp_enable-val is deprecated.  Use ros_mscl-srv:north_comp_enable instead.")
  (north_comp_enable m))
...
(cl:defmethod up_comp_enable-val ((m <SetComplementaryFilter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:up_comp_enable-val is deprecated.  Use ros_mscl-srv:up_comp_enable instead.")
  (up_comp_enable m))
...
(cl:defmethod north_comp_time_const-val ((m <SetComplementaryFilter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:north_comp_time_const-val is deprecated.  Use ros_mscl-srv:north_comp_time_const instead.")
...
(cl:defmethod up_comp_time_const-val ((m <SetComplementaryFilter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:up_comp_time_const-val is deprecated.  Use ros_mscl-srv:up_comp_time_const instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetComplementaryFilter-request>)))
  ...
  "ros_mscl/SetComplementaryFilterRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetComplementaryFilter-request)))
  "Returns string type for a service object of type 'SetComplementaryFilter-request"
  "ros_mscl/SetComplementaryFilterRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetComplementaryFilter-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetComplementaryFilter-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetComplementaryFilter-response> is deprecated: use ros_mscl-srv:SetComplementaryFilter-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetComplementaryFilter-response>)))
  ...
  "ros_mscl/SetComplementaryFilterResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetComplementaryFilter-response)))
  "Returns string type for a service object of type 'SetComplementaryFilter-response"
  "ros_mscl/SetComplementaryFilterResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetComplementaryFilter)))
  ...
  "ros_mscl/SetComplementaryFilter")