...
(cl:defmethod cl:initialize-instance :after ((m <SetGyroBias-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGyroBias-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetGyroBias-request> is deprecated: use ros_mscl-srv:SetGyroBias-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetGyroBias-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGyroBias-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetGyroBias-response> is deprecated: use ros_mscl-srv:SetGyroBias-response instead.")))
