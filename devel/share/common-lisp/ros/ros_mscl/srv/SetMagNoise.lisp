...
(cl:defmethod cl:initialize-instance :after ((m <SetMagNoise-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMagNoise-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetMagNoise-request> is deprecated: use ros_mscl-srv:SetMagNoise-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetMagNoise-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMagNoise-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetMagNoise-response> is deprecated: use ros_mscl-srv:SetMagNoise-response instead.")))
