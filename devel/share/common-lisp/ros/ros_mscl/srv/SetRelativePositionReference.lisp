...
(cl:defmethod cl:initialize-instance :after ((m <SetRelativePositionReference-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetRelativePositionReference-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetRelativePositionReference-request> is deprecated: use ros_mscl-srv:SetRelativePositionReference-request instead.")))

(cl:ensure-generic-function 'source-val :lambda-list '(m))
(cl:defmethod source-val ((m <SetRelativePositionReference-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:source-val is deprecated.  Use ros_mscl-srv:source instead.")
  (source m))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <SetRelativePositionReference-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:frame-val is deprecated.  Use ros_mscl-srv:frame instead.")
  (frame m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <SetRelativePositionReference-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_mscl-srv:position-val is deprecated.  Use ros_mscl-srv:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetRelativePositionReference-request>)))
  ...
  "ros_mscl/SetRelativePositionReferenceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetRelativePositionReference-request)))
  "Returns string type for a service object of type 'SetRelativePositionReference-request"
  "ros_mscl/SetRelativePositionReferenceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetRelativePositionReference-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetRelativePositionReference-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_mscl-srv:<SetRelativePositionReference-response> is deprecated: use ros_mscl-srv:SetRelativePositionReference-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetRelativePositionReference-response>)))
  ...
  "ros_mscl/SetRelativePositionReferenceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetRelativePositionReference-response)))
  "Returns string type for a service object of type 'SetRelativePositionReference-response"
  "ros_mscl/SetRelativePositionReferenceResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetRelativePositionReference)))
  ...
  "ros_mscl/SetRelativePositionReference")