...
class GetAccelBiasModelRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetAccelBiasModelRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetAccelBiasModelRequest
    let len;
    let data = new GetAccelBiasModelRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetAccelBiasModelRequest(null);
    return resolved;
    }
};

class GetAccelBiasModelResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetAccelBiasModelResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetAccelBiasModelResponse
    let len;
    let data = new GetAccelBiasModelResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetAccelBiasModelResponse(null);
...
module.exports = {
  Request: GetAccelBiasModelRequest,
  Response: GetAccelBiasModelResponse,
  md5sum() { return 'b507c17fd666c16c0721d62595a47085'; },
  datatype() { return 'ros_mscl/GetAccelBiasModel'; }
};
