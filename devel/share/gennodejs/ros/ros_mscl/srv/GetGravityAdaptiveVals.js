...
class GetGravityAdaptiveValsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetGravityAdaptiveValsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetGravityAdaptiveValsRequest
    let len;
    let data = new GetGravityAdaptiveValsRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetGravityAdaptiveValsRequest(null);
    return resolved;
    }
};

class GetGravityAdaptiveValsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.enable = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetGravityAdaptiveValsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetGravityAdaptiveValsResponse
    let len;
    let data = new GetGravityAdaptiveValsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_mscl/GetGravityAdaptiveValsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetGravityAdaptiveValsResponse(null);
...
module.exports = {
  Request: GetGravityAdaptiveValsRequest,
  Response: GetGravityAdaptiveValsResponse,
  md5sum() { return '88594dfd6d7363edbe6f8e16638532cc'; },
  datatype() { return 'ros_mscl/GetGravityAdaptiveVals'; }
};
