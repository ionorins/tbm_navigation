...
class GetMagAdaptiveValsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetMagAdaptiveValsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetMagAdaptiveValsRequest
    let len;
    let data = new GetMagAdaptiveValsRequest(null);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'ros_mscl/GetMagAdaptiveValsRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMagAdaptiveValsRequest(null);
    return resolved;
    }
};

class GetMagAdaptiveValsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.enable = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetMagAdaptiveValsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetMagAdaptiveValsResponse
    let len;
    let data = new GetMagAdaptiveValsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_mscl/GetMagAdaptiveValsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMagAdaptiveValsResponse(null);
...
module.exports = {
  Request: GetMagAdaptiveValsRequest,
  Response: GetMagAdaptiveValsResponse,
  md5sum() { return '88594dfd6d7363edbe6f8e16638532cc'; },
  datatype() { return 'ros_mscl/GetMagAdaptiveVals'; }
};
