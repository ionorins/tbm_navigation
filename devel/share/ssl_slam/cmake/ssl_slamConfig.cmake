...
if(ssl_slam_CONFIG_INCLUDED)
  return()
endif()
set(ssl_slam_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ssl_slam_SOURCE_PREFIX /home/warwickboring/catkin_ws/src/ssl_slam)
  set(ssl_slam_DEVEL_PREFIX /home/warwickboring/catkin_ws/devel)
  set(ssl_slam_INSTALL_PREFIX "")
  set(ssl_slam_PREFIX ${ssl_slam_DEVEL_PREFIX})
else()
  set(ssl_slam_SOURCE_PREFIX "")
  set(ssl_slam_DEVEL_PREFIX "")
  set(ssl_slam_INSTALL_PREFIX /home/warwickboring/catkin_ws/install)
  set(ssl_slam_PREFIX ${ssl_slam_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ssl_slam' is deprecated")
...
set(ssl_slam_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/warwickboring/catkin_ws/src/ssl_slam/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(ssl_slam_INCLUDE_DIRS "")
  set(_include_dirs "/home/warwickboring/catkin_ws/src/ssl_slam/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ssl_slam_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ssl_slam' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ssl_slam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/warwickboring/catkin_ws/src/ssl_slam/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ssl_slam_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ssl_slam_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ssl_slam_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ssl_slam_NUM_DUMMY_TARGETS)
      set(ssl_slam_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ssl_slam::wrapped-linker-option${ssl_slam_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ssl_slam_NUM_DUMMY_TARGETS "${ssl_slam_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ssl_slam::wrapped-linker-option${ssl_slam_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ssl_slam_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ssl_slam_LIBRARY_DIRS ${lib_path})
      list(APPEND ssl_slam_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ssl_slam'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ssl_slam_LIBRARIES ${lib})
    endif()
  endif()
...
set(ssl_slam_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ssl_slam_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ssl_slam_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ssl_slam_dep}_FOUND)
      find_package(${ssl_slam_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ssl_slam_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ssl_slam_INCLUDE_DIRS ${${ssl_slam_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ssl_slam_LIBRARIES ${ssl_slam_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ssl_slam_dep}_LIBRARIES})
  _list_append_deduplicate(ssl_slam_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ssl_slam_LIBRARIES ${ssl_slam_LIBRARIES})

  _list_append_unique(ssl_slam_LIBRARY_DIRS ${${ssl_slam_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(ssl_slam_EXPORTED_TARGETS ${${ssl_slam_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ssl_slam_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
